...
{
    //nếu tương tác table có nghiệp vụ riêng nằm ngoài các nghiệp vụ chung của RepositoryBase, 
    //  thì sẽ viết thêm phương thức đó.
    ...
    public interface IProductCategoryRepository : IRepository<ProductCategory>
    {
        ...
        //IEnumerable: sẽ trả về 1 list, phù hợp với thao tác với linq.
    ...
    {
        //constructor
        //Ở đây sẽ kế thừa lại các nghiệp vụ chung đã đc define trong RepositoryBase, 
        //  lúc này các nghiệp vụ chung sẽ đc dùng dễ dàng, ko duplicate code.
        ...
        public ProductCategoryRepository(IDbFactory dbFactory) : base(dbFactory)
        {
            ...
            //(vì mỗi lần DbContext ko dùng tới hoặc dùng xong ở 1 hành động của table nào đó sẽ được 
            //      tự động hủy bằng Disposable gọi trong DbFactory)
        }
        ...
        {
            //this.DbContext kế thừa từ RepositoryBase
